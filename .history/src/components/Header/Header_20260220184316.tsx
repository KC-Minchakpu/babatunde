      ...
      <div className={styles.container}>
        ...
        <nav className={styles.nav}>
            ...
            {isOpen && (
              <div className={styles.dropdownMenu}>
                <Link
                  href="/about/history"
                  className={
                    isActive("/about/history") ? styles.active : ""
                  }
                >
                  Our History
                </Link>
                ...
                <Link
                  href="/about/mission"
                  className={
                    isActive("/about/mission") ? styles.active : ""
                  }
                >
                  Mission & Vision
                </Link>
                <Link
                  href="/about/values"
                  className={
                    isActive("/about/values") ? styles.active : ""
                  }
                >
                  Core Values
                </Link>
                <Link
                  href="/about/careers"
                  className={
                    isActive("/about/careers") ? styles.active : ""
                  }
                >
                  Careers
                </Link>
          ...
          <Link
            href="/students-life"
            className={
              isActive("/students-life") ? styles.active : ""
            }
          >
            Students Life
          </Link>
