        ...
        <div className={styles.row}>
          ...
          <div className={styles.textCol}>
            <div className={styles.textWrapper}>
              ...
              <p className={styles.lead}>
                In 1970, he formally established Samtecol Nigeria Limited, expanding his engineering 
                and electro-technical services across Nigeria. During this formative period, 
                ...
                strong professional competence. Building upon decades of practical experience 
                and engineering heritage, Baba T Engineering was established in 1991 to continue 
                and expand this tradition of excellence.
              </p>
            </div>
          </div>
