            ...
            <div className={styles.textWrapper}>
             <h2 className={styles.title}>How We Started</h2>
              <p className={styles.lead}>
                <strong>Baba T Engineering Limited</strong> was founded in 1991 by its 
               <strong>Babatunde Emmanuel Olugbemi</strong>, in Kaduna, Nigeria. The company was established 
              ...
              <p className={styles.lead}>
                ...
                by <strong>Elder Deacon Engineer Samuel Olorunloshe Olugbemi</strong>, a highly respected engineer 
