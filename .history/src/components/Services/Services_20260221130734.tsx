...
const services = [
  {
    ...
    description:
      "We specialize in diagnosing and repairing smartphone motherboard faults caused by power issues, water damage, short circuits, and component failure. Our technicians use advanced tools and precision techniques to restore full functionality, helping you avoid the cost of replacing your device.",
    icon: Smartphone,
  },
  {
