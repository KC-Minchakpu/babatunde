...
const services = [
  ...
  },
  {
    ...
    description:
      "Our circuit board repair service focuses on identifying and fixing damaged, burnt, or malfunctioning components on electronic boards. Whether caused by electrical faults, physical damage, or wear, we provide reliable repairs that extend the life of your equipment and ensure optimal performance.",
    icon: CircuitBoard,
  },
  {
